...
exports.extractBarcodeValue = extractBarcodeValue;
exports.generateBarcodeValueFromImage = generateBarcodeValueFromImage;
 ...
 */
async function extractBarcodeValue(imagePath) {
    try {
 ...
 */
async function generateBarcodeValueFromImage(imagePath) {
    try {
